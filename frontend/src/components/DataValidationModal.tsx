...
export const DataValidationModal: React.FC<DataValidationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-4 mx-auto p-5 border w-[95%] max-w-6xl shadow-lg rounded-md bg-white mb-4">
        {/* Header */}
        <div className="flex justify-between items-center mb-6">
          <div>
            <h3 className="text-xl font-bold text-gray-900">Data Validation & Export</h3>
        ...
        {summaryLoading && (
          <div className="flex items-center justify-center py-8">
            ...
            <span className="text-gray-600">Loading extraction summary...</span>
          </div>
        )}
        ...
        {summary && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Left Panel - Summary & Entity List */}
            <div className="lg:col-span-1 space-y-6">
              {/* Summary Stats */}
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="text-sm font-medium text-blue-900 mb-3">Extraction Summary</h4>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-blue-700">Total Records:</span>
                    <span className="font-medium text-blue-900">{summary.totalRecords.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-blue-700">Entity Types:</span>
                    <span className="font-medium text-blue-900">{summary.entityTypes.length}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-blue-700">Job ID:</span>
                    <span className="font-mono text-xs text-blue-900">{summary.jobId.slice(-8)}</span>
                  </div>
                </div>
              </div>
              ...
              {/* Entity List */}
              <div className="space-y-2">
                <h4 className="text-sm font-medium text-gray-900">Entity Types</h4>
                  ...
                  {previewLoading ? (
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                      <div className="flex">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-yellow-800">No Preview Data</h4>
